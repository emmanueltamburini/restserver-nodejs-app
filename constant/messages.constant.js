...
export const PRODUCT_IS_NOT_AVAILABLE = 'Product is not available';
...
export const PRODUCT_ID_DOES_NOT_EXIST = (id) => `Product with id ${id} does not exist`;
...
export const PRODUCT_ALREADY_TAKEN = (product = '') => `${product} product name already taken`;
